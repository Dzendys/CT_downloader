...
class CT_gold:
    """CT downloader for Golden Prague
    ...
    def getID(self) -> str:
        ...
        try:
            ...
            print(f"Nenašel jsem název videa! (Error: {e})")
            return
        
        print("Zjišťuji ID videa...")
        try:
            iframes:Tag = soup.find_all('iframe')
            ...
            print(f"Nenašel jsem ID videa! (Error: {e})")
            return
